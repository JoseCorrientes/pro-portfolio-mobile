...
const data = {
  ...
  projectData: [
    {
        pName: ["REQUEST FOR LEAVE (Vacation or Sick Leave)- N8N FLOW USING WEBHOOKS LIKE AN REST API", "PEDIDO POR LICENCIA (Vacaciones o Enfermedad) - FLUJO N8N USANDO WEBHOOKS COMO UNA API REST"],
        pDescription: [
...
For a detailed look at the workflow, access the WEB ACCESS URL and read the README.MD file.`,
    ...
    {
        pName: ["REQUEST FOR LEAVE (Vacation or Sick Leave)- N8N FLOW USING FORMS", "PEDIDO POR LICENCIA (Vacaciones o Enfermedad) - FLUJO N8N USANDO FORMULARIOS"],
        pDescription: [
