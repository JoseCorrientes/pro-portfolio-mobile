...
import CV from "../../files/CV_Jose_Ernesto_Garcia_2026.docx";
import Resume from "../../files/RESUME_Jose_Ernesto_Garcia_2026.docx";
import { data } from "../../text/text";

function LandingPage({ toggleLanguage, lang }) {
  return (
    <div className={LandingPageCSS.main_Container}>
      <div className={LandingPageCSS.language_Bar}>
        <p>{data.language[lang]}</p>
        <div className={LandingPageCSS.switch_Button}>
          <input
            type="checkbox"
            name="switch_Button"
            value={true}
      ...
      <div className={LandingPageCSS.lower_Container}>
        <div className={LandingPageCSS.buttons_Container}>
          ...
          {lang === 1 && (
            <div className={LandingPageCSS.button_Cv}>
              <a
                href={CV}
                download="CV_Jose_Ernesto_Garcia_2026.docx"
                target="_blank"
          ...
          {lang === 0 && (
            <div className={LandingPageCSS.button_Cv}>
              <a
                href={Resume}
                download="RESUME_Jose_Ernesto_Garcia_2026.docx"
                target="_blank"
                rel="noopener noreferrer"
              >
                {data.buttonCV[lang]}
        ...
        <div className={LandingPageCSS.contactus_Container}>
          ...
          <br />
          <span className={LandingPageCSS.container_Linkedin_title}>
            LINKEDIN:{" "}
          </span>
          <a
          ...
          <span className={LandingPageCSS.container_OtherLink_title}>
            GITHUB:{" "}
          </span>
          <a
          ...
          <p className={LandingPageCSS.contact_Link1}>(+54) 9 3794 599549</p>
          <span className={LandingPageCSS.container_OtherLink_title}>
            {data.country[lang]}:{" "}
          </span>
          <p className={LandingPageCSS.contact_Link1}>Argentina (Corrientes)</p>
        </div>
      </div>
    </div>
  );
