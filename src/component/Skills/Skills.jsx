  ...
  return (
    <div>
      <header>
        ...
        <Link className={SkillsCSS.link_Visibility} to="/">
          <button className={SkillsCSS.button_Back_Menu}>
            {data.backHome[lang]}
          </button>
        </Link>
      </header>
          ...
          <div className={SkillsCSS.skill_Card_Main_Container}>
            <div className={SkillsCSS.skill_Card}>
              ...
              <div className={SkillsCSS.element_Card}>
                ...
                <span className={SkillsCSS.tanstackquery}>
                  <span className={SkillsCSS.tip}>TanStack Query</span>
                </span>
              ...
              <div className={SkillsCSS.element_Card_Soft}>
                <div className={SkillsCSS.element_Card_Lang_Title}>
                  {data.languageSpanish[lang]}
                </div>
                <div className={SkillsCSS.element_Card_Lang_Container}>
                  <p className={SkillsCSS.element_Card_Lang_Item}>
                    {data.languageW[lang]}:
                  </p>
      ...
      <div className={SkillsCSS.button_Back_Menu_Lower_Container}>
        <Link to="/">
          <button className={SkillsCSS.button_Back_Menu_Button}>
            {data.backHome[lang]}
          </button>
        </Link>
        *
